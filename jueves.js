...
let startTime = '18:25'; // Hora predeterminada
...
function startCountdownSequence() {
    const sequences = [
        ...
        { duration: 10 * 60, message: "Apertura:", next: 2 },
        { duration: 35 * 60, message: "Alabanza:", next: 3 },
        { duration: 30 * 60, message: "Estudio Bíblico:", next: 4 },
        { duration: 15 * 60, message: "Ministración y ofrenda:", next: 5 },
