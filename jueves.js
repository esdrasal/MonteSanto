function updateClock() {
    ...
    // Verifica si es 6:25 PM
    if (hours === '18' && minutes === '24' && seconds === '59') {
...
function startSecondCountdown() {
    ...
    startCountdown(10 * 60, "Apertura:", startAlabanzaCountdown); //10 mimnutos de apertura
}
...
function startAlabanzaCountdown() {
    ...
    startCountdown(35 * 60, "Alabanza:", startEstudioCountdown); //35 min de alabanza
}
...
function startMinistracionCountdown() {
    ...
    messageElement.textContent = "Ministración y ofrenda";
    startCountdown(15 * 60, "Ministración y ofrenda:"); //15 min de ministración y ofrendas
}
